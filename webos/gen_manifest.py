...
with open(outfile, 'w') as f:
    json.dump({
        ...
        'iconUri': 'https://github.com/LuisYeah1234-hub/RSDKv5-Decompilation/raw/master/webos/icon.png',
        'sourceUrl': 'https://github.com/LuisYeah1234-hub/RSDKv5-Decompilation',
        'rootRequired': False,
        'ipkUrl': pkgfile,
        'ipkHash': {
            'sha256': pkghash
